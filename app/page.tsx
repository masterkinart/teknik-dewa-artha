      ...
      <section id="about">
        <div className="container about-grid">
          <div className="about-text">
            ...
            <h2>Pendahuluan</h2>
            <p>
              Membahas mengenai awal mulai perjalanan perusahaan karir kami dimulai, seiringan
              dengan perspektif kami terhadap lajur perputaran barang-barang industri yang
              semakin meningkat. Melalui perkembangan zona industri yang pesat dalam
              efektifitas dan efisiensinya, CV. TEKNIK DEWA ARTHA berdiri guna ikut serta untuk
              ambil bagian dalam pemenuhan kebutuhan dalam segala bidang industri maupun
              pembangunan umum.
            </p>
            <div className="vm-grid">
              <div className="vm-card">
                ...
                <p>
                  Kami selalu berusaha untuk meningkatkan efisiensi dan efektifitas perusahaan
                  untuk menjadi mitra yang handal dan profesional demi mewujudkan kepuasan
                  pelanggan.
                </p>
                <p>
                  Senantiasa memenuhi seluruh ragam jenis barang permintaan pelanggan, sehingga
                  menjadikan perusahaan kami sebagai &quot;one stop shopping&quot; segala jenis
                  keperluan perindustrian dan pembangunan umum.
                </p>
              </div>
              <div className="vm-card">
                <div className="vm-icon">
                ...
                <ul>
                  <li>Secara berkala meningkatkan performa dalam sistem manajemen.</li>
                  <li>
                    Menjalin hubungan kerjasama yang baik dan berkelanjutan dengan mitra
                    perusahaan/konsumen dibidangnya.
                  </li>
                  <li>
                    Memenuhi kebutuhan sparepart/mengerjakan produk custom dengan menjaga hasil
          ...
          <div className="about-media">
            <div className="about-photo">
              <svg viewBox="0 0 400 500" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="200" cy="230" r="70" fill="none" stroke="#e7edf5" strokeWidth="4" opacity="0.7" />
                <rect x="150" y="300" width="100" height="130" rx="6" fill="#e7edf5" opacity="0.85" />
                <rect x="165" y="320" width="70" height="10" rx="3" fill="#16375c" />
                <rect x="165" y="340" width="70" height="10" rx="3" fill="#16375c" />
                <rect x="165" y="360" width="45" height="10" rx="3" fill="#16375c" />
              </svg>
            </div>
      ...
      <section className="legal-section" id="legality">
        <div className="container">
          <div className="legal-head">
            ...
            <p>
              Kami mengutamakan transparansi dan kepatuhan hukum untuk menjamin keamanan dan
              kepercayaan setiap kemitraan bisnis.
            </p>
          ...
          <div className="legal-grid">
            <div className="legal-card">
              ...
              <div>
                ...
                <p>No 01 tanggal 01 Juli 2025, Notaris Andiny Rachmadani Ekaputri, S.H., M.Kn.</p>
              </div>
            </div>
            <div className="legal-card">
              <div className="legal-icon">
            ...
            <div className="legal-card">
              ...
              <div>
                <h3>Bidang Usaha</h3>
                <p>
                  Pipes, fitting, valve, aksesoris pendukung industrial, wiremesh, fab. gasket /
                  seal / mechanical seal, plat, stainless, kuningan, besi, pemipaan jalur minyak /
                  air / pengkabelan, alat teknik, alat mekanikal, aksesoris SPBU.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="contact-section" id="contact">
        <div className="container contact-grid">
          <div className="contact-info">
            <h2>Hubungi Kami</h2>
            <p>
              Tim teknis kami siap membantu memberikan solusi terbaik untuk kebutuhan industri
              Anda. Silakan hubungi kami melalui saluran berikut.
            </p>
      ...
      <footer>
        <div className="container footer-inner">
          <div className="footer-left">
            ...
            <div className="copy">© 2024 PT. TEKNIK DEWA ARTHA. All rights reserved.</div>
          </div>
